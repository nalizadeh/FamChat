...
/*
 * Copyright 2007 N.A.J. nalizadeh.com - All rights reserved. nalizadeh.com
...
public class CellsLayout implements LayoutManager2 {
	...
	private Cell fromString(String constraints) {
		...
		return new Cell(row, col, rowOver, colOver, hAlign, vAlign, usePref == 1, null);
	}
			...
			for (int c = 0; c < cols.size(); c++) {
				...
				if (cell.comp != null) {
					...
					if (cell.usePreferred) {
						...
						cell.comp.setSize(
							cell.bounds.width + point.x,
							cell.bounds.height + point.y
						);
					}
				}
			}
	...
	public void addLayoutComponent(Component comp, Object constraints) {
		...
		Cell c1 =
			constraints instanceof Cell ? (Cell) constraints : fromString(constraints.toString());
	...
	/**
	 * Stellt Komponenten mit einem farbigen Rahmen dar. Die SpaceCell-Objekten werden rot und die
	 * Anderen blau dargestellt. Wird nur zum Debugen verwendet.
	 *
	 * @param
	 *
	 * @return
	...
	public static class CellRow {
		...
		public String toString() {
			return origHeight == FILL ? "CellsLayout.FILL"
	...
	public static class CellColumn {
		...
		public String toString() {
			return origWidth == FILL ? "CellsLayout.FILL"
	...
	public static class Cell {
		...
		public Cell(int row, int col) {
			this(row, col, 0, 0, LEFT, TOP, false, null);
		}

		public Cell(int row, int col, int rowOverlapp, int colOverlapp) {
			this(row, col, rowOverlapp, colOverlapp, LEFT, TOP, false, null);
		}

		public Cell(int row, int col, int rowOverlapp, int colOverlapp, boolean usePreferred) {
			this(row, col, rowOverlapp, colOverlapp, LEFT, TOP, usePreferred, null);
		}

		public Cell(int row, int col, Component comp) {
			this(row, col, 0, 0, LEFT, TOP, false, comp);
		}
		...
		public Cell(
			...
			this(row, col, rowOverlapp, colOverlapp, hAlign, vAlign, usePreferred, null);
		}
		...
		public String toString() {
			return row + ", " + col + ", " + (usePreferred ? "1" : "0") + ", " + rowOverlapp + ", "
			+ colOverlapp + ", " + hAlign + ", " + vAlign;
		}
		...
		public String toDesignerString() {
			...
			String s =
				"new CellsLayout.Cell(" + row + ", " + col + ", "
				+ (usePreferred ? "true" : "false") + ", " + rowOverlapp + ", " + colOverlapp
				+ ", CellsLayout." + ha + ", CellsLayout." + va + ")";
			;
			return s;
		}
	}
